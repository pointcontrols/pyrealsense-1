...
def parse_lrs_classes():
    ...
    with io.open('lrs_globals', "wb") as ser_globals:
        pickle.dump(lrs_globals, ser_globals)
    ...
    with io.open('lrs_parsed_classes', "wb") as ser_classes:
        pickle.dump(classes, ser_classes)
...
setup(name='pyrealsense',
      ...
      keywords='realsense',
      data_files=[('pyrealsense', ['lrs_parsed_classes', 'lrs_globals'])],
